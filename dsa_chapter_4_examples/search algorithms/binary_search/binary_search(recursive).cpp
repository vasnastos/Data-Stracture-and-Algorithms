...
//Αναδρομική εκδοχή αλγορίθμου δυαδικής αναζήτησης.
template <class T>int binary_search(T *b,T key,int left,int right)
{
    ...
    {
        return binary_search(b,key,middle+1,right);
    }
    else 
    {
        return binary_search(b,key,left,middle-1);
    }
}
